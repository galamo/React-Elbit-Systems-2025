  ...
  return (
    <div className="example-card">
      ...
      <p className="description">
        React 19 automatically memoizes simple calculations. No need for
        useMemo!
      </p>
...
function ObjectCreationExample() {
  ...
  return (
    <div className="example-card">
      ...
      <p className="description">
        React 19 automatically memoizes objects and arrays when their values
        don't change.
      </p>
...
function ExpensiveCalculationExample() {
  ...
  return (
    <div className="example-card expensive">
      ...
      <p className="description">
        React 19 doesn't automatically memoize expensive computations. Use
        useMemo!
      </p>
...
const filteredAndSorted = useMemo(() => {
  ...
  return result;
      ...
      <div className="warning">
        <strong>⚠️ Note:</strong> Watch the console. Filtering only happens when
 ...
 * @deprecated DONT USE THIS FUNCTION ANYMORE (YOU WILL MESS WITH DAEL)
 */
function App() {
  return (
    <div className="app">
      ...
      <footer className="app-footer">
        <p>
          💡 <strong>Pro Tip:</strong> In React 19, start without useMemo. Add
          it only when you identify performance issues through profiling.
        </p>
      </footer>
    </div>
  );
