...
import WebWorkersExample from "./components/features/8-web-workers/Example";
import WebWorkersExercise from "./components/features/8-web-workers/Exercise";
import LikeButton from "./components/features/7-use-optimistic-2/Example";
    ...
    <div className="home">
      ...
      <div className="features-grid">
        ...
        <FeatureCard
          number="8"
          title="Web Workers"
          description="Run heavy calculations without blocking the UI"
          link="/web-workers"
        />
        <FeatureCard
          number="9"
      ...
      <div className="app">
        ...
        <div className="content">
          <Routes>
            ...
            <Route
              path="/web-workers/exercise"
              element={<WebWorkersExercise />}
            />
